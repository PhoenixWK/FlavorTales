    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    // Public translation read (tourists view translated POI/shop content)
                    .requestMatchers(HttpMethod.GET, "/api/poi/*/translation/*").permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/shop/*/translation/*").permitAll()
