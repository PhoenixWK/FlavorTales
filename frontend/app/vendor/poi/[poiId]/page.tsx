    ...
    <main className="p-4 sm:p-6 md:p-8">
      ...
      <div className="mb-6 flex items-start justify-between gap-4 flex-wrap">
        ...
        {poi.status?.toLowerCase() === "pending" ? (
          <div className="inline-flex items-center gap-1.5 rounded-xl bg-amber-100 border border-amber-300 text-amber-700 text-sm font-semibold px-4 py-2 cursor-not-allowed select-none">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
